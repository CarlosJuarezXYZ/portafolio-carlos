...
const { Container, Title, StyledForm, Socials, StyledItem, InputStyled } =
...
const ContactSection = () => {
  const onFinish = (values: unknown) => {
    const {
      ...
      email,
      message: userMessage,
    } = values as { name: string; email: string; message: string };
      ...
      >
        ...
        <StyledForm layout="vertical" onFinish={onFinish}>
          ...
          <StyledItem
            ...
            label="Correo"
            rules={[
              { required: true, type: "email", message: "Correo no válido" },
            ]}
          >
            <InputStyled />
          </StyledItem>
